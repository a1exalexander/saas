...
import InvestorRecoveryStart from '@/components/investor/auth/recovery/InvestorRecoveryStart.vue';
import InvestorRecoverySendEmail from '@/components/investor/auth/recovery/InvestorRecoverySendEmail.vue';
import InvestorRecoveryConfirm from '@/components/investor/auth/recovery/InvestorRecoveryConfirm.vue';
import InvestorRecoveryPassword from '@/components/investor/auth/recovery/InvestorRecoveryPassword.vue';
...
export default {
  ...
  components: {
    IconLogo,
    CloseButton,
    InvestorRecoveryStart,
    InvestorRecoverySendEmail,
    InvestorRecoveryConfirm,
    InvestorRecoveryPassword,
    IconLongArrowLeft,
    SubtleIcon,
  },
  data() {
